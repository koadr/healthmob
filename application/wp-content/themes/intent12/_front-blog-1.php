...
<div id="front-blog">
	<div id="front-blog-inner" class="front container fix">
		...
		<?php $my_query = "ignore_sticky_posts=1&showposts=3"; $my_query = new WP_Query($my_query); ?>
		<?php if ($my_query->have_posts()) : while ($my_query->have_posts()) : $my_query->the_post(); ?>
		<?php $classes = ('2'==$my_query->current_post)?'entry one-fourth last':'entry one-fourth'; ?>
